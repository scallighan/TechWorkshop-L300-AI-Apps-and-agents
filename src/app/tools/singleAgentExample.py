...
print(f"Initializing Azure OpenAI client with endpoint: {endpoint} and deployment: {deployment}")
...
if __name__ == "__main__":
    # Example usage
    user_input = "Hi, I'm looking for some paint for a DIY project. What colors do you have?"
